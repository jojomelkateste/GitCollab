...
git merge main
	...
	Le responsable a créé une branche \texttt{conflitTest} contenant 
	un fichier avec une ligne à modifier. Récupérez-la et basculez dessus :
	\begin{lstlisting}[style=bashstyle]
git fetch origin
git switch -c conflitTest origin/conflitTest
	\end{lstlisting}
	Modifiez la ligne indiquée par le responsable, puis commitez 
	\textbf{sans pusher} :
	\begin{lstlisting}[style=bashstyle]
git add -A
git commit -m "modification de prenom-nom"
	\end{lstlisting}
	Prévenez le responsable que vous avez commité. Il va alors pousser 
...
git push --force-with-lease
	...
	Le responsable met alors sa branche à jour avec votre version :
	\begin{lstlisting}[style=bashstyle]
git fetch origin
