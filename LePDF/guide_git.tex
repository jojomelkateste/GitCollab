...
La branche main est sécurisé, seul le propriétaire peut la fusionné avec une branche en se connectant à gitHub. La solution est de cloner en mode lecture seule via:

\begin{lstlisting}[style=bashstyle]
git fetch origin branche-collegue
git checkout FETCH_HEAD
# on passe alors en mode "detached HEAD"
# en cas dechec verifiez que vous avez bien sauvegarder vos changement sur la branche locale
\end{lstlisting}

En faisant ainsi si on essaye de pusher par accident Git répond :
...
\item Crée une clef ssh : \verb|ssh-keygen -t ed25519 -C "ton_email@exemple.com"| regardez la ou est la clef est afficher la. exemple \verb|cat /c/Users/melka/.ssh/id_ed25519.pub| me la transmettre pour vous autoriser à cloner le dépôt. 
  ...
  \item Créé vous une branche et travailler dessus pour tout tester. 
\end{enumerate}
