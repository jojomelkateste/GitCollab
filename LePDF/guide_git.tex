...
\begin{itemize}
	...
	\item \textbf{Chacun possède sa propre branche de travail.} Vous y êtes le seul maître à bord. \textbf{Note :} Les branches personnelles ne sont pas protégées 
	techniquement, mais la règle collective est de ne jamais intervenir 
	sur la branche d'un autre. La protection du \texttt{main} reste 
	la garantie essentielle de l'intégrité du document final. Nous verrons la sécurité aprés.%, ce qui élimine à 100\% le risque de voir votre travail écrasé par un collègue.
\end{itemize}
