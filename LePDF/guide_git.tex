...
\begin{lstlisting}[style=bashstyle]
	...
	git checkout origin/branche-collegue
...
\begin{enumerate}
\item Crée une clef ssh : \verb|ssh-keygen -t ed25519 -C "ton_email@exemple.com"| regardez la ou est la clef est afficher la. exemple \verb|cat /c/Users/melka/.ssh/id_ed25519.pub| me la transmettre pour vous autoriser à cloner le dépôt. 

  \item Aller dans un dossier et cloner le projet \verb|git clone git@github.com:jojomelkateste/GitCollab.git|
  
  \item Créé vous une branche avec votre nom et basculer dessus:
 \verb|git switch -c nom-ma-branch|
 \item Consulter le dossier \verb|Exercice_collab\Ressources|, j'aurais au préalable crée un fichier latex avec votre nom. Sinon attendez que je le fasse puis faites \verb|git switch main|, \verb|git pull|, \verb|git switch votre-branche|,  \verb|git merge main|.
 \item Réalisez des modifications dans le fichier latex 
\end{enumerate}
